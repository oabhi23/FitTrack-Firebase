...
/**
 * Created by Abhi on 1/9/2018.
 */

public class DeadliftDatabaseHelper extends SQLiteOpenHelper {
    ...
    public DeadliftDatabaseHelper(Context context, String dbName, int dbVersion){
