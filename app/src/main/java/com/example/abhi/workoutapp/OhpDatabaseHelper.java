...
/**
 * Created by Abhi on 1/12/2018.
 */

public class OhpDatabaseHelper extends SQLiteOpenHelper{
    ...
    public OhpDatabaseHelper(Context context, String dbName, int dbVersion){
